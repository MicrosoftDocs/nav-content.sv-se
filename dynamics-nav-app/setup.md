...
---
# <a name="setting-up-dynamics-nav"></a>Ställa in Dynamics NAV
...
Vissa områden kräver att du är administratör i din [!INCLUDE[d365fin](includes/d365fin_md.md)]-prenumeration. Mer information finns i [Konfiguration och administration i Dynamics NAV](admin-setup-and-administration.md).  
