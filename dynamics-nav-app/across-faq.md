...
Om du har frågor om [!INCLUDE[d365fin](includes/d365fin_md.md)] som du inte hittar svar för i denna dokumentation, kan du fråga communityn för Dynamics NAV. Mer information finns i [Dynamics NAV, Business edition community](https://community.dynamics.com/business). Supportteamet publicerar dessutom, tips och råd. Mer information finns i [supportblogg för Dynamics NAV](https://blogs.msdn.microsoft.com/dyn365finsupport).  
