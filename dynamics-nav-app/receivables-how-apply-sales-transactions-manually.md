...
När du får en inbetalning av en kund eller när du gör en kontant återbetalning till en kund måste du bestämma om inbetalningen eller återbetalningen ska kopplas till en eller flera öppna debet- eller kredittransaktioner. Du kan ange exakt det belopp som du vill koppla. Du kan exempelvis endast vilja koppla en del av betalningen och därigenom endast delvis koppla kundreskontratransaktioner. Det är viktigt att i något skede stänga (koppla) alla kundreskontratransaktioner för att erhålla rätt kundstatistik och utskrifter för kontoutdrag och räntefakturor.

Du kan koppla kundreskontratransaktioner på tre olika sätt:
...
1. Välj ikonen **Söka efter sida eller rapport** i det övre högra hörnet, gå till **Inbetalningsjournal** och välj sedan relaterad länk.
...
5. Använd **Externt dokumentnr** för att lagra ett ID, t.ex kundens checknummer.
6. I fältet **Kontotyp** väljer du **Kund**.
7. I fältet **Bankkontonr.** markera önskat redovisningskonto.
8. Gör något av följande om du vill bokföra kopplingen samtidigt som du bokför journalen.
9. I fältet **Motkontotyp** väljer du **Redovisningskonto** för kontantbetalningar eller **Bankkonto** för andra typer av betalningar.
10. I **balanskontonr.** välj kontantkontot för kontantbetalningar eller rätt bankkonto för andra typer av betalningar.
11. Bokför journalen.
...
1. Välj ikonen **Söka efter sida eller rapport** i det övre högra hörnet, gå till **Inbetalningsjournal** och välj sedan relaterad länk.
2. Ange information om den transaktion som ska kopplas på den första journalraden.
3. I fältet **Dokumenttyp** anger du **Betalning**.
4. I fältet **Kontotyp** anger du **Kund**.
5. I fältet **Motkontotyp** anger du **Bankkonto.**
6. I fältet **Kopplas till ver.nr.** väljer du fältet för att öppna fönstret **Koppla kundtransaktioner**.
7. I fönstret **Koppla kundtransaktioner** markerar du transaktionen som du vill koppla betalningen till.
8. I fältet **Belopp att koppla** anger du det belopp som du vill koppla till transaktionen. Om du inte anger något belopp kopplas det maximala beloppet.

    Längst ned i fönstret **Koppla kundtransaktioner** kan du se beloppet i fältet **Kopplat belopp** och om kopplingen balanserar.
9. Välj **OK**. I fönstret **Inbetalningsjournal** visas nu transaktionen som du har valt i **Kopplas till dokumenttyp** och **Kopplas till ver.nr.** .
10. Bokför inbetalningsjournalen.
...
4. I fältet **Kontotyp** anger du **Kund**.
5. I fältet **Motkontotyp** anger du **Bankkonto.**
6. I fältet **Belopp** anger du den fullständiga betalningen som ett negativt belopp.
7. Om du vill koppla betalningen till flera kundreskontratransaktioner vid bokföringen väljer du åtgärden **Koppla transaktioner**.
8. Markera raderna med de poster som du vill koppla transaktionen till och väljer sedan åtgärden **Koppla till ID**.
9. På varje rad i fältet **Belopp att koppla** anger du det belopp som du vill koppla till posten. Om du inte anger något belopp kopplas det maximala beloppet.
...
1. Välj ikonen **Söka efter sida eller rapport** i det övre högra hörnet, gå till **Försäljningskreditnota** och välj sedan relaterad länk.
...
9. Välj ikonen **Söka efter sida eller rapport** i det övre högra hörnet, gå till **Kunder** och välj sedan relaterad länk för att se transaktionerna. Bläddra till kortet för att den relevanta kunden ska se de redovisningstransaktioner.
...
Koppla kundreskontratransaktioner i olika valutor till varandra måste vara aktiverad. Mer information finns i [Så här aktiverar du koppling av kundreskontratransaktioner till olika valutor](finance-setup-how-enable-application-ledger-entries-different-currencies.md).
...
## <a name="to-unapply-an-application-of-customer-entries"></a>Så här tar du bort en koppling av kundtransaktioner
