...
---
# <a name="set-up-marketing-and-contact-management"></a>Ställ in Marknadsföring och Kontakthantering
...
Du kan skapa marknadsförings- och kontakthantering från fönstret **Marknadsföringsinställningar**. Om du vill öppna fönstret **Marknadsföringsinställningar** i det övre högra hörnet väljer du ikonen **Söka efter sida eller rapport**, anger **Marknadsföringsinställningar** och sedan väljer relaterad länk.
...
Försäljnings- och inköpsdokument kan automatiskt återges i Dynamics NAV som interaktioner (till exempel order, fakturor, inleveranser och så vidare) liksom ebrev, telefonsamtal och meddelanden.
