...
## <a name="define-a-job-responsibility-code"></a>Definiera arbetsansvarkod
...
1. Välj ikonen **söka efter sida eller rapport** i det övre högra hörnet, gå till **arbetsansvar** och välj sedan relaterad länk.
2. Välj åtgärden **Ny** och fyll i en kod och en beskrivning. Koden kan bestå av högst 11 tecken, både siffror och bokstäver.

## <a name="assign-job-responsibilities-to-a-contact-person"></a>Så här tilldelar du arbetsansvaret till en kontaktperson
