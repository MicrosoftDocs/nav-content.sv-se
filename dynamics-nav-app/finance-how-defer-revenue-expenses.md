...
2. Välj åtgärden **Ny**.
3. Fyll i fälten som behövs för att skapa ett redovisningskonto för periodiserade intäkter. Mer information finns i [Redovisning och kontoplan](finance-setup-general-ledger.md).
3. Upprepa steg 2 och 3 för att skapa ett nytt redovisningskonto för periodiserade kostnader.
...
1. Välj ikonen **Söka efter sida eller rapport** i det övre högra hörnet, gå till **Periodiseringsmallar** och välj sedan relaterad länk.
2. Välj åtgärden **Ny**.
...
1. Välj ikonen **Söka efter sida eller rapport** i det övre högra hörnet, gå till **Periodiseringssammanfattning för försäljning** och välj sedan relaterad länk.
