...
## <a name="define-a-mailing-group-code"></a>Definiera en utskicksgruppkod.
...
1. Välj ikonen **Söka efter sida eller rapport** i det övre högra hörnet, gå till **utskicksgrupper** och välj sedan relaterad länk.
2. Välj åtgärden **Ny** och fyll i en kod och en beskrivning. Koden kan bestå av högst 11 tecken, både siffror och bokstäver.

## <a name="assign-mailing-groups-to-a-contact"></a>Tilldela utskicksgrupp till en kontakt
1. Öppna kontakten .
...
Antalet utskicksgrupper som du har tilldelat kontakter anges automatiskt i fältet **Antal utskicksgrupper** på avnisttet **Segmentering** på **Kontakt**-fönstret.
