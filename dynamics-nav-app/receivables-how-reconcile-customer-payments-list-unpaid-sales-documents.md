---
title: "Så här stämmer du av kundutbetalningar manuellt från en lista med obetalda försäljningsdokument"
author: SorenGP
ms.custom: na
ms.date: 09/22/2016
ms.reviewer: na
...
1. Välj ikonen **Söka efter sida eller rapport** i det övre högra hörnet, gå till **Inställning av betalningsregistrering** och välj sedan relaterad länk. Alternativt kan du i fönstret **Betalningsregistrering** välja åtgärden **Inställning**.
...
1. Välj ikonen **Söka efter sida eller rapport** i det övre högra hörnet, gå till **Betalningsregistrering** och välj sedan relaterad länk.  
...
Om en betalning i banken inte representeras av ett dokument i Dynamics NAV, kan du öppna en förifylld redovisningsjournal från fönstret **Betalningsregistrering** för att bokföra betalningen direkt till motkontot, utan att koppla betalningen till ett dokument. Du kan också vilja registrera betalning i journalen tills ursprunget för betalningen har fastställts. Mer information finns i avsnittet "Så här registrerar eller bokför du en betalning utan ett relaterat dokument".

## <a name="to-customer-payments-with-discounts-manually"></a>Kundbetalningar med rabatter manuellt
...
Den här proceduren förklarar fyra olika procedurer för att bokföra rabatterade betalningar i fönstret **Betalningsregistrering**.
...
Det relaterade dokument stängas.
...
Om en betalning i banken inte representeras av ett dokument i Dynamics NAV, kan du öppna en förifylld redovisningsjournalrad från fönstret **Betalningsregistrering** för att bokföra betalningen direkt till motkontot, utan att koppla betalningen till ett dokument. Du kan också vilja registrera betalning i journalen tills ursprunget för betalningen har klargjorts.
...
3. Fyll i de återstående fälten på redovisningsjournalraden, till exempel kundnummer eller belopp och annan information från kontoutdraget. Mer information finns i [Så här arbetar du med redovisningsjournaler](ui-work-general-journals.md).
